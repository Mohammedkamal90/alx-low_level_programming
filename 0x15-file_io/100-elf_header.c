 ...
 * @e_ident: pointer array containin ELF class.
 */
void print_class(unsigned char *e_ident)
{
	printf(" Class: ");
...
/**
 * print_data - Print of an ELF header.
...
/**
 * print_abi - Print version of an ELF header.
 ...
 * Description: If file cannot closed - exit code 98.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
