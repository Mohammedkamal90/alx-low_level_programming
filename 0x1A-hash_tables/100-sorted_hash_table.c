...
/**
 * shash_table_create - creat  sorte hash table
...
/**
 * shash_table_set - add element to sort hash table
 * @ht: pointer to sort hash table.
...
/**
 * shash_table_print - print sort hash table in order.
...
/**
 * shash_table_print_rev - print  sort hash table in reverse order
